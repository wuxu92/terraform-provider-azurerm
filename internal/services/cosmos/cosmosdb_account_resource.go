...
func resourceCosmosDbAccountCreate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if key, err := customermanagedkeys.ExpandKeyVaultOrManagedHSMKey(d, customermanagedkeys.OptionallyVersioned, meta.(clients.Client).Account.Environment.ManagedHSM); err != nil {
