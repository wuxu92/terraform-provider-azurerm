...
func (m KeyVaultRoleAssignmentResource) Create() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) (err error) {
			...
			if model.Name == "" {
				model.Name, err = uuid.GenerateUUID()
				if err != nil {
					return fmt.Errorf("generate uuid for assignName: %v", err)
				}
			}
...
func (m KeyVaultRoleAssignmentResource) Read() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) error {
			...
			id, err := parse.ParseMHSMNestedItemID(meta.ResourceData.Id())
			if err != nil {
				return err
			}
...
func (m KeyVaultRoleAssignmentResource) Delete() sdk.ResourceFunc {
	return sdk.ResourceFunc{
		...
		Func: func(ctx context.Context, meta sdk.ResourceMetaData) error {
			...
			client := meta.Client.KeyVault.MHSMRoleAssignClient
			if _, err := client.Delete(ctx, id.VaultBaseUrl, id.Scope, id.Name); err != nil {
