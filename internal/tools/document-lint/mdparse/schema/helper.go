...
// check if compositeLit presents []string{}
...
// check if a composite node if map[string]*pluginsdk.Resource
func IsConpositeMapOfResource(node *ast.CompositeLit) bool {
